...
for i in range(100): 
    ...
    for i in range(random.randint(1000,50000)):
        ...
        if op == 1:
            f.write(str(client) + " B " + id + " " + tickers[random.randint(0,len(tickers)-1)] + " " + str(random.randint(100,2000)) + " " + str(random.randint(10,1000)) )
        elif op == 2:
            f.write(str(client) + " S " + id + " " + tickers[random.randint(0,len(tickers)-1)] + " " + str(random.randint(100,2000)) + " " + str(random.randint(10,1000)) )
        elif op == 3:
            f.write(str(client) + " C " + id)
    f.write("x")
    f.close()
